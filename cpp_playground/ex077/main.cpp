...
int main() {
  ...
  paper p2(
      "An improved multi staged algorithmic process for the examination "
      "timetabling problem",
      "ANOR");
...
2. An improved multi staged algorithmic process for the examination timetabling
problem ANOR Researcher: Christos Valouxis UoP
1. A two phase approach for the nurse rostering problem EJOR
Researcher: Efthymios Housos UoP
1. A two phase approach for the nurse rostering problem EJOR
2. An improved multi staged algorithmic process for the examination timetabling
problem ANOR Researcher: George Goulas UoP
1. A two phase approach for the nurse rostering problem EJOR
Researcher: Panayiotis Alefragis UoPe
1. A two phase approach for the nurse rostering problem EJOR
2. An improved multi staged algorithmic process for the examination timetabling
problem ANOR Authors per paper A two phase approach for the nurse rostering
problem, EJOR
...
An improved multi staged algorithmic process for the examination timetabling
problem, ANOR
1. Christos Gogos UoI

...
public:
  // προκειμένου να μην κληθεί αυτόματα ο default constructor της Person, καλείται στο initializion list τελευταίος ο constructor Person(int)
...
name: petros semester: 1 specialty: programming PAYED [size of object = 80 bytes]
Teaching Assistant says: Hello
Person(string) constructor called
Student(string, int) constructor called
Student says: Hello
Person(string) constructor called
Teacher(string, string) constructor called
Professor says: hello
*/
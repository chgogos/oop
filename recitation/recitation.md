...
* std::map
    ...
    * [container6.cpp](./container6.cpp)

* std::unordered_map

    Χρησιμοποιώντας ένα std::unordered_map μετρήστε το πλήθος των ψηφίων που υπάρχουν σε όλους τους ακέραιους αριθμούς από το 1 μέχρι το 10000000. Εμφανίστε το πλήθος των παρατηρήσεων κάθε ψηφίου. Γιατί η τρέχουσα λύση εκτελείται ταχύτητα σε σχέση με τη λύση του προηγούμενου ερωτήματος.

    * [container7.cpp](./container7.cpp)

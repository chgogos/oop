...
ostream& operator<<(ostream& os, Card c) {
  os << "[" << card_string[c.value - 1] << " of " << suit_string[c.suit]
     << "s]";
  return os;
}
...
/* έξοδος
Poker Hand  --[Ten of clubs][Ten of hearts][Jack of diamonds][Three of

...
int main()
{
    ...
    std::cout << "CHECK 7 [delete_at_position]  (not implemented yet)" << std::endl;
    ll.delete_at_position(3);
    ll.print();

    std::cout << "CHECK 8 [insert_at_position] (not implemented yet)" << std::endl;
    ll.insert_at_position(3, 54);
    ll.print();

    std::cout << "CHECK 9 [reverse] (not implemented yet)" << std::endl;
    ll.reverse();
    ll.print();
}
...
10 11 16 22 70 78 90
CHECK 7 [delete_at_position] (not implemented yet)
10 11 16 22 70 78 90
CHECK 8 [insert_at_position] (not implemented yet)
10 11 16 22 70 78 90
CHECK 9 [reverse] (not implemented yet)
10 11 16 22 70 78 90
*/
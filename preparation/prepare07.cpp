...
class employee : public person {
 ...
 public:
  ...
  virtual std::string info() {
    return "Name: " + name + " DOB: " + day_of_birth +
           " ACCOUNT_NO: " + acct_no;
  }
};
...
class professor : public employee {
 ...
 public:
  professor(std::string n, std::string dob, std::string an)
      : employee(n, dob, an) {}
...
class administrative_employee : public employee {
 ...
 public:
  administrative_employee(std::string n, std::string dob, std::string an,
                          int yoe)
      : employee(n, dob, an), years_of_experience(yoe) {}

  std::string info() {
    return employee::info() +
           " Experience: " + std::to_string(years_of_experience) +
...
class student : public person {
 ...
 public:
  student(std::string n, std::string dob, int sem)
      : person(n, dob), semester(sem) {}

  std::string info() {
    return "Name: " + name + " DOB: " + day_of_birth +
           " SEMESTER: " + std::to_string(semester) + " (STUDENT)";
  }
};
...
Name: Maria DOB: 1/6/1965 ACCOUNT_NO: 0002 Specializations: Algorithms
Artificial Intelligence Mathematics  (PROFESSOR) Name: Kostas DOB: 2/4/1985
ACCOUNT_NO: 0003 Experience: 10 (ADMINISTRATIVE EMPLOYEE) Name: Georgia DOB:
1/3/2003 SEMESTER: 2 (STUDENT) List of persons Name: Georgia DOB: 1/3/2003
SEMESTER: 2 (STUDENT) Name: Kostas DOB: 2/4/1985 ACCOUNT_NO: 0003 Experience: 10
(ADMINISTRATIVE EMPLOYEE) Name: Maria DOB: 1/6/1965 ACCOUNT_NO: 0002
Specializations: Algorithms Artificial Intelligence Mathematics  (PROFESSOR)
Name: Nikos DOB: 1/1/1980 ACCOUNT_NO: 0001
*/
